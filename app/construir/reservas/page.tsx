  ...
  return (
    <main className="w-full bg-[#FAFAFA] min-h-screen pt-24 pb-20">
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        {/* Cabeçalho */}
        <h1 className="text-[#191F37] text-[42px] font-black mb-2">Reserva de Equipamentos</h1>
        <p className="text-gray-600 mb-12">Selecione o equipamento e agende seu horário no calendário ao lado.</p>
