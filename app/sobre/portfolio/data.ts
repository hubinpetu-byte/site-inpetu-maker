...
A solução para esses desafios emergiu de uma abordagem estratégica e inovadora. A equipe optou por um Design Modular e Materiais Leves, utilizando uma estrutura que combinava a leveza com a rigidez. A escolha de materiais compósitos e a prototipagem de peças via impressão 3D para os componentes mais complexos facilitaram não apenas a montagem, mas também a possibilidade de ajustes e otimizações contínuas ao longo do processo.`,
  ...
  {
    slug: "workshop-impressao-3d",
    titulo: "Workshop de Impressão 3D - FDM",
    subtitulo: "Imersão em Fabricação Digital",
    autor: "Agosto, 2025",
    categoria: "Workshops", // Tag para o segundo filtro
    resumo: "Este workshop ofereceu uma imersão prática no universo da fabricação digital, explorando fundamentos de fatiamento e materiais.",
    banner: "/portfolio/banner-workshop.png",
    desafio: "Capacitar usuários iniciantes a operar máquinas de impressão 3D com segurança e eficiência.",
    solucao: "Metodologia 'mão na massa' com instrutores experientes orientando desde o arquivo 3D até a peça final.",
    projetoDetalhe: "Os participantes exploraram os fundamentos dos formatos de arquivo 3D e as principais configurações de software.",
    comoContribuimos: "Disponibilizamos o laboratório completo de impressão 3D e insumos para todos os participantes.",
    imagensGaleria: ["/portfolio/workshop-1.jpg", "/portfolio/workshop-2.jpg"],
    parceiros: [
      { nome: "Finep", logo: "/logos/finep.png" }
    ],
    downloads: [
      { nome: "Guia de Fatiamento", tipo: "pdf" }
    ]
  }
];